    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="tambah-mahasiswa" data-table-target="table-mahasiswa"  class="form-horizontal" action="<?php echo e(route('admin.mahasiswa.add')); ?>" method="POST">
...
<!-- /.modal --><?php /**PATH C:\xampp\htdocs\mahasiswaprestasi\resources\views/admin/mahasiswa/add.blade.php ENDPATH**/ ?>