...
Route::group(['as' =>'admin.','middleware'=> 'auth'],function(){
    Route::get('/', function () {
        ...
        $data['vokasi'] = count(\App\Model\Mahasiswa::where('fakultas','VOKASI')->get());
        $data['fbs'] = count(\App\Model\Mahasiswa::where('fakultas','FBS')->get());
        $data['fio'] = count(\App\Model\Mahasiswa::where('fakultas','FIO')->get());
        $data['fe'] = count(\App\Model\Mahasiswa::where('fakultas','FE')->get());
        $data['fish'] = count(\App\Model\Mahasiswa::where('fakultas','FISH')->get());
